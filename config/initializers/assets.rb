...
Rails.application.config.assets.precompile += %w( tactics.js.coffee )
Rails.application.config.assets.precompile += %w( tasks.js.coffee )
Rails.application.config.assets.precompile += %w( activities.js.coffee )
Rails.application.config.assets.precompile += %w( teams.js.coffee )
Rails.application.config.assets.precompile += %w( userboards.js.coffee )
Rails.application.config.assets.precompile += %w( userboard.scss )
Rails.application.config.assets.precompile += %w( utilities.js.coffee )
Rails.application.config.assets.precompile += %w( utilities.scss )
