Myapp::Application.routes.draw do
  ...
  resources :activities do 
    collection do
      ...
      get "get_userboard_tasks", to: "activities#get_userboard_tasks", as: :get_userboard_tasks
    end  
  end
  resources :assets do
    collection do
  ...
  scope :tactics do
    ...
    get "get_all_tactic_attachments", to: "tactics#get_all_tactic_attachments", as: :get_tactic_attachments
  end
  ...
  scope :utilities do
    get "report_hours", to: "utilities#report_hours", as: :report_hours
    get "get_filtered_members", to: "utilities#get_filtered_members", as: :get_filtered_members
    get "generate_report_hours", to: "utilities#generate_report_hours", as: :generate_report_hours
  end
